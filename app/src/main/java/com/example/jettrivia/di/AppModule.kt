...
import com.example.jettrivia.repository.QuestionRepositoryImp
...
object AppModule {
    ...
    @Singleton
    @Provides
    fun provideQuestionRepository(questionApi: QuestionApi): QuestionRepository = QuestionRepositoryImp(questionApi)
